...
<div id="ss-plugin" class="wrap">
    ...
    <p>There are many services that can be used to check for spam or protect
        your website against spammers. Most require
        a key so that only registered users can use their services. All of the
        services here can be used by Stop
      ...
      <label id="ss_subhead" for="chksfs">
        ...
        <fieldset>
            ...
            <p>This API key is used for querying the Project Honeypot Deny List.
                ...
                can register and get an API key at <a
