...
if ( ! function_exists( 'foundationpress_scripts' ) ) :
	...
	wp_enqueue_style( 'main-stylesheet', get_stylesheet_directory_uri() . '/css/foundation.css' );
    	// Temporarily Enqueue the default Stylesheet.
	wp_enqueue_style( 'default-stylesheet', get_stylesheet_directory_uri() . '/style.css' );
	...
	wp_register_script( 'equalize', get_template_directory_uri() . '/js/foundation.equalizer.js', array('jquery'), '5.5.2', true );

	wp_register_script( 'init', get_template_directory_uri() . '/js/custom/init-foundation.js', array('jquery'), '5.5.2', true );
